...
FOR %%x IN ("P:\Alchemystic\Git\AlchemysticWebsite\Xampp\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=P:\Alchemystic\Git\AlchemysticWebsite\Xampp\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=P:\Alchemystic\Git\AlchemysticWebsite\Xampp\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=P:\Alchemystic\Git\AlchemysticWebsite\Xampp\php\php.exe"
