...
if ('P:\Alchemystic\Git\AlchemysticWebsite\Xampp\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('P:\Alchemystic\Git\AlchemysticWebsite\Xampp\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
